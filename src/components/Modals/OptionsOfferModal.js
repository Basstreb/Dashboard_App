...
import DeleteModal from "./DeleteOfferModal";

export default function OptionsOfferModal(props) {

    const { optionsModalVisible, closeOptionsModalVisible, id, offer } = props;
